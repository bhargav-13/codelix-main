      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <Link href="/home" className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-cyan-300 bg-clip-text text-transparent">
              Codelix
            </Link>
            <p className="text-gray-400 text-sm">
              Creating beautiful, functional digital experiences that drive results.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-2">
              <p className="text-gray-400 text-sm">Email: contact@codelix.com</p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <p className="text-gray-400 text-sm text-center">
            &copy; {currentYear} Codelix. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
